  ...
  const handleClearCache = async () => {
    ...
    if (result.isConfirmed) {
      try {
        ...
        await Swal.fire({
          title: 'Sıfırlandı!',
          text: 'Önbellek ve cihaz veritabanı temizlendi. Uygulama v2.1.9 olarak yeniden başlatılacak.',
          icon: 'success',
          timer: 1500,
              ...
              <Card.Body className="p-4 p-md-5">
                ...
                <div className="text-center py-4 bg-body-secondary rounded-4">
                  ...
                  <div className="d-flex flex-column gap-2 align-items-center">
                    <div className="badge bg-primary bg-opacity-10 text-primary px-3 py-2 rounded-pill">Sürüm v2.1.9</div>
